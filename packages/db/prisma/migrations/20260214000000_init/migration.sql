...
CREATE TABLE "ProductPricing" (
    ...
    "smallWholesalePrice" DECIMAL(10,2) NOT NULL,
    "largeWholesalePrice" DECIMAL(10,2) NOT NULL,
    "smallWholesaleMinQty" INTEGER NOT NULL DEFAULT 1,
    "smallWholesaleStep" INTEGER NOT NULL DEFAULT 1,
    "largeWholesaleMinQty" INTEGER NOT NULL DEFAULT 1,
    "largeWholesaleStep" INTEGER NOT NULL DEFAULT 1,
