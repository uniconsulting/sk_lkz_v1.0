                  ...
                  {mode === "business" ? (
                    ...
                    <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
                      ...
                      <div className="glass-border rounded-xl bg-white/35 p-4 h-full flex flex-col">
                        <div className="text-[16px] font-semibold text-[#26292e]/70">
                        ...
                        <div className="mt-4 grid grid-cols-1 gap-2 flex-1">
                          {RETAIL_OPTIONS.map((opt) => {
                            ...
                            return (
                              <label
                                key={opt}
                                className="border border-dark/10 rounded-lg bg-white/55 px-4 py-3 flex items-center gap-3 cursor-pointer select-none"
                              >
                                <input
                                  type="checkbox"
                                  checked={checked}
                                ...
                                <span
                                  aria-hidden
                                  className={[
                                    "h-2 w-2 rounded-full border border-[#26292e]/20 transition",
